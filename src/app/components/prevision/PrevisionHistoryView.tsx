...
import { Download, FileSpreadsheet, Loader2, History } from 'lucide-react';
...
/* ─── Component ─────────────────────────────────── */
export function PrevisionHistoryView({ projetId, isOpen, onClose }: PrevisionHistoryViewProps) {
                  ...
                  >
                    ...
                    <td style={{ ...tdStyle, textAlign: 'center' }}>
                      <button
                        ...
                        disabled={downloadingId === prevision.id}
